...
import { Pause, Play, Ticket, XCircle } from "lucide-react";
...
import { MembershipForm } from "../../shared/ui/Forms";
  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        ...
        <button className="btn-secondary" onClick={() => setModal("membership")}>
          <Ticket size={18} /> {activeMembership ? "Редактировать абонемент" : "Создать абонемент"}
        </button>
      </div>
